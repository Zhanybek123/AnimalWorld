...
struct AnimalsDataService: AnimalsDataServiceProtocol {
    ...
    func fetchData() async -> [Animal] {
        return [
            ...
            Animal(type: "mammal", pictureName: "Bear", name: "Bear", videoSourceID: "K-3snCVlrJ8", inhabitantLocation: LandmarkAnnotation(
            ...
            Animal(type: "mammal ", pictureName: "Bison", name: "Bison", videoSourceID: "zGfn7UKSnB4", inhabitantLocation: LandmarkAnnotation(
            ...
            Animal(type: "bird", pictureName: "Chicken", name: "Chicken", videoSourceID: "wYKJkHcaMzE", inhabitantLocation: LandmarkAnnotation(
            ...
            Animal(type: "mammal", pictureName: "Koala", name: "Koala", videoSourceID: "PzU-DjUMzsg", inhabitantLocation: LandmarkAnnotation(
